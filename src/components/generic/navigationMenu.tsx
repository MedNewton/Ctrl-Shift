...
export function NavigationMenuContent({ className, ...props }: NavigationMenuContentProps) {
  return (
    <RadixNavigationMenu.Content
      ...
      className={cn(
        "top-full left-0 p-1 mt-1.5 z-200 w-full overflow-hidden rounded-xl md:absolute md:left-1/2 md:w-auto md:-translate-x-1/2",
        "bg-[#952527]/25 backdrop-blur-xl backdrop-saturate-125 border border-white/10",
