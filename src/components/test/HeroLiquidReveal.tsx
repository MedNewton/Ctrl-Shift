...
export default function HeroLiquidReveal({
          ...
          >
            <Stack direction="row" alignItems="center" justifyContent="center" gap={0.5} width="fit-content">
              <Typography variant="h3" fontWeight={600} color={theme.palette.text.primary} textAlign="center">
                The Biggest Blockchain<br />Event in Southern Italy
              </Typography>
            </Stack>
          </motion.div>
        ...
        >
          <Stack
            ...
            sx={{
              ...
              textDecoration: "none",
              cursor: "pointer",
              bgcolor: theme.palette.brand.napulETHYellow2.main,
              "&:hover": { backgroundColor: theme.palette.brand.napulETHYellow1.main },
            }}
          >
            <Typography variant="subtitle1" fontWeight={600} color={theme.palette.background.default}>
              Get Your Tickets
            </Typography>
            <HiOutlineArrowRight size={16} strokeWidth={2} color={theme.palette.background.default} />
          </Stack>
        </motion.div>
      </Stack>
    </Stack>
